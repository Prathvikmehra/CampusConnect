...
export const MentorDirectory: React.FC = () => {
  const { mentors, isLoading, error, filters, setFilters, industries, companies } =
    useMentorshipDirectory();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Request Modal */}
      {selectedMentor && (
        <RequestMentorshipModal mentor={selectedMentor} onClose={() => setSelectedMentorId(null)} />
      )}
    </div>
  );
};
